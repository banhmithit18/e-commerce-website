...
<head>
    ...
    <!-- Template CSS -->
    <link rel="stylesheet" href="..\admin\css\style-starter.css">
...
<body class="sidebar-menu-collapsed">
    ...
    <!-- //image logo -->
        ...
        <div class="logo-icon text-center">
            <a href="index.html" title="logo"><img src="../admin/images/logo.png" alt="logo-icon"> </a>
        </div>
        <!-- //logo end -->
                                ...
                                <li class="dropdown profile_details_drop">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" id="dropdownMenu3"
                                        ...
                                        <div class="profile_img">
                                            <img src="..\admin/images/profileimg.jpg" class="rounded-circle" alt="" />

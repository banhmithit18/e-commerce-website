<?php
 ...
 ?>
    </div><div class="container"><div class="row"><div class="services-breadcrumb"><div class="agile_inner_breadcrumb"><div class="container"><ul class="w3_short"><li><a href="index.php">Home</a><i>|</i></li><li>God Eater 2: Rage Burst</li></ul></div></div></div></div><div class="banner-bootom-w3-agileits"><div class="container"><div class="row"><!-- //tittle heading --><div class="col-4 single-right-left "><div class="grid images_3_of_2"><div class="flexslider">
        <ul class="slides">   <li data-thumb="uploads/godeater2rageburst1.jpg">
                        <div class="thumb-image">
                            <img src="uploads/godeater2rageburst1.jpg" data-imagezoom="true" class="img-responsive" alt="">
                        </div>
                    </li>   <li data-thumb="uploads/godeater2rageburst2.jpg">
                        <div class="thumb-image">
                            <img src="uploads/godeater2rageburst2.jpg" data-imagezoom="true" class="img-responsive" alt="">
                        </div>
                    </li>   <li data-thumb="uploads/godeater2rageburst3.jpg">
                        <div class="thumb-image">
                            <img src="uploads/godeater2rageburst3.jpg" data-imagezoom="true" class="img-responsive" alt="">
                        </div>
                    </li>   <li data-thumb="uploads/godeater2rageburst4.jpg">
                        <div class="thumb-image">
                            <img src="uploads/godeater2rageburst4.jpg" data-imagezoom="true" class="img-responsive" alt="">
                        </div>
                    </li><ul></div></div></div><div class="col-8 single-right-left simpleCart_shelfItem "><h3>God Eater 2: Rage Burst</h3><div class="rating1"><span class="starRating"><input id="rating5" type="radio" name="rating" value="5"><label for="rating5">5</label><input id="rating4" type="radio" name="rating" value="4"><label for="rating4">4</label><input id="rating3" type="radio" name="rating" value="3" checked=""><label for="rating3">3</label><input id="rating2" type="radio" name="rating" value="2"><label for="rating2">2</label><input id="rating1" type="radio" name="rating" value="1"><label for="rating1">1</label></span></div><p>
            <span class="item_price">970000 VND</span>
            </p><div class="occasion-cart"><div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
	            	<form id="form1" action="" method="post">
							...
							<input type="hidden" name="product_name" value="God Eater 2: Rage Burst" />
					...
					</form></div></div></div><div class="clearfix"> </div></div></div></div><br><div class="row line"><div>Chi tiết sản phẩm </div><br>Start your journey in GOD EATER Resurrection as a new member of the GOD EATER elit squad. Your mission is to defeat the Aragami and gather material from them for research, but you come to realize that you are being drawn in to a giant conspiracy that will irreversibly alter the fate of humanity. Three years after the events of GOD EATER Resurrection, a mysterious red rain sparks a fatal pandemic called the Black Plague. Members of the Special Unit “Blood”, an affiliate of the Fenrir Organization, are sent to investigate...</div></div><div class="footer-top" id="footer-full">
    <div class="container-fluid" id="banner-footer">
        <div class="container col-8 centerPage " id="title-register-for-new-user">
            <div>
                <span id="font">Bạn là người mới ?</span>
            </div>
            <br>
            <div>
                <span id="font">Hãy đăng kí tài khoản để cập nhật những ưu đãi mới nhất từ Devine Shop</span>
            </div>
            <br>
            <div>
                <input type="button" value="Đăng kí ngay" class="btn btn-primary"
                    style="font-family: 'Roboto-Condensed';">
            </div>
            <br>
            <div>
                <span id="font">Hoặc <a href="#">đăng nhập</a> nếu bạn có tài khoản</span>
            </div>
        </div>
